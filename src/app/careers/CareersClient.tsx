        ...
        <div className="container-main">
          ...
          >
            ...
            <h1 className="hero-title text-5xl md:text-8xl font-black tracking-tighter leading-[0.9] mt-8 uppercase mb-8">
              ...
              <span className="text-[#007AFF] italic uppercase">Engineering.</span>
            </h1>
            <p className="text-white/40 max-w-2xl text-xl md:text-2xl font-medium leading-relaxed mb-16">
        ...
        <div className="container-main">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-[#007AFF]/10 flex items-center justify-center text-[#007AFF] mb-8 border border-[#007AFF]/20">
                  {value.icon}
                </div>
        ...
        <div className="container-main">
          <div className="mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase leading-none mb-4">
              Open <span className="text-[#007AFF] italic">Roles.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {jobPositions.map((job, index) => (
              ...
              >
                <SpotlightCard className="h-full bg-white/5 border border-white/10 p-10 rounded-[24px] flex flex-col group hover:border-[#007AFF]/40 transition-colors">
                  <div className="flex items-center justify-between mb-10">
                    <span className="px-4 py-1.5 bg-[#007AFF]/10 text-[#007AFF] text-[10px] font-black uppercase tracking-widest rounded-full border border-[#007AFF]/20">
                      {job.category}
                    </span>
                  ...
                  <h3 className="text-3xl font-black mb-6 uppercase tracking-tight group-hover:text-[#007AFF] transition-colors">
                    {job.title}
                  </h3>
                  <p className="text-white/40 leading-relaxed mb-10 flex-1 font-medium">
                    {job.description}
                  </p>
                  <div className="flex flex-wrap items-center gap-6 mb-10 pt-8 border-t border-white/5">
                    <div className="flex items-center gap-3 text-[10px] font-mono uppercase tracking-widest text-white/30">
                      <MapPin size={14} className="text-[#007AFF]/60" />
                      {job.location}
                    </div>
                  </div>
                  <Link
                    href={`/careers/apply?role=${job.id}`}
                    className="inline-flex items-center gap-4 text-xs font-black text-[#007AFF] group-hover:gap-6 transition-all uppercase tracking-widest"
                  >
          ...
          <div className="mt-32 maysan-card border-[#007AFF]/20 bg-[#007AFF]/5 text-center p-16 lg:p-24 overflow-hidden relative">
            <div className="relative z-10">
              <h3 className="text-3xl md:text-5xl font-black mb-6 uppercase tracking-tighter">Don&apos;t see a perfect fit?</h3>
              <p className="text-white/40 font-medium max-w-2xl mx-auto mb-12 text-lg">
            ...
            <div className="absolute top-0 left-0 w-full h-full bg-[#007AFF]/5 opacity-50 pointer-events-none" />
          </div>
        </div>
      </section>
