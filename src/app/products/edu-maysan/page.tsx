...
export const metadata: Metadata = {
  ...
  description: "EduMaysan is a comprehensive school management software and ERP solution. Manage admissions, fees, examinations, and more with our cloud-based platform.",
  ...
  openGraph: {
    ...
    description: "Comprehensive school management software and ERP solution for modern educational institutions.",
  },
};
