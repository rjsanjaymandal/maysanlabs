      ...
      <main id="main-content" className="flex items-center justify-center px-4 pt-32 pb-32">
        <div className="w-full max-w-md text-center space-y-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/products" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full border border-white/10 text-foreground/70 font-semibold text-sm hover:bg-white/5 transition-all">
