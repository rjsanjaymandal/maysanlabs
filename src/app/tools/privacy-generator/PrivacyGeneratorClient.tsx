...
import { CheckCircle2, Copy, Shield, FileSignature, Download, Sparkles, Loader2, ClipboardCheck } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
              ...
              <div className="lg:col-span-5 bg-white/[0.02] border border-white/[0.06] rounded-3xl p-6 space-y-4">
                ...
                <div className="border-t border-white/10 pt-3 space-y-2">
                  ...
                  <label className="flex items-center justify-between p-2 bg-black/10 border border-white/5 rounded-lg text-xs cursor-pointer">
