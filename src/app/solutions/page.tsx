...
export const metadata: Metadata = {
  ...
  description: "Maysan Labs offers comprehensive SaaS development services including online stores, CRM systems, custom software, and cloud infrastructure. Build scalable solutions with our expert team.",
  keywords: ["SaaS development services", "custom software development", "online store development", "CRM development", "cloud services", "enterprise software solutions"],
  openGraph: {
